...
if [ ! -d ${MY_ZDOTDIR} ]; then
    ...
    git -c http.sslVerify=false clone --recurse-submodules -j8 ${DOTDIR_REPO} ${repo_dir} -b ${DOTDIR_BRANCH:-master}
...
#scarey stuff
defaults write com.googlecode.iterm2 PrefsCustomFolder "$MY_ZDOTDIR"
